import unittest
from ContinAlgorithm import ContinAlgorithm
import pandas as pd

class TestContinAlgorithm(unittest.TestCase):
    def Test_LoadData(self):
        algo = ContinAlgorithm()
...
if __name__ == '__main__':
    try:
        ...
        suite.addTest(TestContinAlgorithm('Test_LoadData'))
